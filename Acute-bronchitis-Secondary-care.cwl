...
steps:
  ...
  other-acute-bronchitis-secondary-care---secondary:
    run: other-acute-bronchitis-secondary-care---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  bronchitis---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: other-acute-bronchitis-secondary-care---secondary/output
  ...
  acute-bronchitis-secondary-care-organism---secondary:
    run: acute-bronchitis-secondary-care-organism---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  acute-bronchitis-secondary-care-pneumoniae---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: acute-bronchitis-secondary-care-organism---secondary/output
  output-cases:
